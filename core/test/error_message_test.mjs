...
describe('error_message', () => {
  ...
  describe('構文エラー', () => {
    ...
    it('配列の要素を区切るカンマの書き忘れ (#2436)', () => {
      cmp('A=[[0,0,0,0][0,0,0,0]]', [
        '配列の直後にある『[...]』を配列アクセスとして解析できません。',
        '配列の要素を区切る『,』(カンマ)を忘れていませんか。',
        'main.nako3'
      ], NakoSyntaxError)
    })
    it('要素が2個のカンマ書き忘れも検出する (#2436)', () => {
      cmp('A=[[0,0][0,0]]', [
        '配列の要素を区切る『,』(カンマ)を忘れていませんか。',
        'main.nako3'
      ], NakoSyntaxError)
    })
    it('辞書の中のカンマ書き忘れも検出する (#2436)', () => {
      cmp('A={"a":[[0,0][0,0]]}', [
        '配列の要素を区切る『,』(カンマ)を忘れていませんか。',
        'main.nako3'
      ], NakoSyntaxError)
    })
    it('配列の直後の不正なプロパティ指定 (#2436)', () => {
      cmp('A=[]$', [
        '配列の直後にある『$プロパティ』の指定が不正です。',
        'main.nako3'
      ], NakoSyntaxError)
    })
    it('変数のみの式', () => {
