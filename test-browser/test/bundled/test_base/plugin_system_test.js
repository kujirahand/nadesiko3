...
describe('plugin_system_test', () => {
  ...
  it('出現回数 #2482', () => {
    ...
    cmp('「」で「」の出現回数を表示。', '0')
    cmp('「あいう」で「」の出現回数を表示。', '0')
    cmp('「」で「あ」の出現回数を表示。', '0')
    cmp('「あいう」で「あ」の出現回数を表示。', '1')
    cmp('「000」で0の出現回数を表示。', '3') // 数値は文字列化して数える
  })
  it('シングル文字列', () => {
    cmp('\'abcd\'を表示。', 'abcd')
  })
  ...
  it('ゼロ埋め', () => {
    ...
    cmpex('「5」を(0/0)でゼロ埋して表示。', { name: 'NakoError', message: /有限の整数/ }) // #2480
    cmpex('「5」を1000001でゼロ埋して表示。', { name: 'NakoError', message: /大きすぎます/ }) // #2480
  })
  it('空白埋め', () => {
    cmp('10を3で空白埋め。表示。', ' 10')
    ...
    cmpex('「5」を(0/0)で空白埋して表示。', { name: 'NakoError', message: /有限の整数/ }) // #2480
    cmpex('「5」を1000001で空白埋して表示。', { name: 'NakoError', message: /大きすぎます/ }) // #2480
  })
  it('リフレイン', () => {
    cmp('「ab」を3でリフレインして表示。', 'ababab')
    cmp('「x」を0でリフレインして表示。', '')
    cmp('「5」を2でリフレインして表示。', '55')
    cmp('「x」を0.5でリフレインして表示。', '')
    cmp('「x」を2.5でリフレインして表示。', 'xx')
    cmp('「」を1000000でリフレインして表示。', '')
    cmpex('「x」を(0/0)でリフレインして表示。', { name: 'NakoError', message: /有限の整数/ }) // #2481
    cmpex('「x」を-1でリフレインして表示。', { name: 'NakoError', message: /0以上の整数/ }) // #2481
    cmpex('「x」を-0.5でリフレインして表示。', { name: 'NakoError', message: /0以上の整数/ }) // #2481
    cmpex('「x」を1000001でリフレインして表示。', { name: 'NakoError', message: /大きすぎます/ }) // #2481
    cmpex('「x」を(10の21のべき乗)でリフレインして表示。', { name: 'NakoError', message: /大きすぎます/ }) // #2481
  })
  it('配列要素数', () => {
  ...
  it('英数記号全角半角変換', () => {
    ...
    cmp('S=「｟」を英数記号半角変換。SのASCを表示', '65375')
    cmp('S=「｠」を英数記号半角変換。SのASCを表示', '65376')
    cmp('S=CHR(0xFF00)を英数記号半角変換。SのASCを表示', '65280')
    cmp('S=「～」を英数記号半角変換。SのASCを表示', '126')
    cmp('「｟｠～」を英数記号半角変換して表示', '｟｠~')
    cmp('S=「｟」を半角変換。SのASCを表示', '65375')
  })
  it('カタカナ全角半角変換', () => {
    ...
    cmp('「ｲﾛﾊﾆﾎﾍﾄ」をカタカナ全角変換して表示', 'イロハニホヘト') // #2457
    cmp('「ﾄ」をカタカナ全角変換して表示', 'ト') // #2457
    cmp('「ｳﾞ」をカタカナ全角変換して表示', 'ヴ') // #2478
    cmp('「ﾞｷ」をカタカナ全角変換して表示', 'ﾞキ') // #2478
    cmp('「ﾟﾋ」をカタカナ全角変換して表示', 'ﾟヒ') // #2478
    cmp('「ﾞ」をカタカナ全角変換して表示', 'ﾞ') // #2478
    cmp('「ﾟ」をカタカナ全角変換して表示', 'ﾟ') // #2478
    cmp('「ｶﾞ」をカタカナ全角変換して表示', 'ガ') // #2478
    cmp('「ﾜﾞ」をカタカナ全角変換して表示', 'ワﾞ') // #2478
    cmp('「ｦﾞ」をカタカナ全角変換して表示', 'ヲﾞ') // #2478
    cmp('「ｶﾟ」をカタカナ全角変換して表示', 'カﾟ') // #2478
    cmp('「ヴ」をカタカナ半角変換して表示', 'ｳﾞ') // #2478
    cmp('「ｳﾞ」を全角変換して表示', 'ヴ') // #2478
    cmp('「ヴ」を半角変換して表示', 'ｳﾞ') // #2478
    cmp('「ｱｶﾞｳﾞ」をカタカナ全角変換して表示', 'アガヴ') // #2478
    cmp('「ｳﾞｳﾞ」をカタカナ全角変換して表示', 'ヴヴ') // #2478
  })
  it('JS関数実行', () => {
