...
@echo on
if "%TARGET_BASIC%"=="YES" (
  call node_modules\.bin\cross-env TZ=Asia/Tokyo NODE_ENV=development node_modules\.bin\karma start %SINGLEWATCH% --browsers %BROWSER%%HEADLESS% --reporters=mocha test-browser/test/bundled/karma.config.base.js
)
@echo on
