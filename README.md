...
- (2026-09-07) 現行TS版と互換性のある[なでしこ3(Go版)](https://github.com/kujirahand/nadesiko3go/)を公開
- (2026-09-01) v3.8.1で古い__getProp/__setPropによるプロパティアクセスを廃止
- (2026-04-05) v3.7.17より生成AIの活用を大々的に開始
