...
import { Token, Ast,FuncList, FuncListItem, FuncArgs, NewEmptyToken, SourceMap } from './nako_types.mjs'
...
export class NakoParser extends NakoParserBase {
  ...
  ySwitch (): Ast | null {
    ...
    while (!this.isEOF()) {
      ...
      // 違えば？
      let cond: Ast|null = null
      let condToken: Token|null = this.peek()
