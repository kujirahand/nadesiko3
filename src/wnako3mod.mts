...
import { NakoCompiler, LoaderToolTask } from '../core/src/nako3.mjs'
...
export class WebNakoCompiler extends NakoCompiler {
   ...
   */
  async loadDependencies (code: string, filename: string, preCode = '', localFiles: any = {}) {
        ...
        return {
          task: (async () => {
            ...
            return () => {
              ...
              const globalNavigator: any = navigator
          ...
          return {
            task: (() => {
              return (new Promise((resolve, reject) => {
                const s: string = localFiles[filePath]
                resolve(s)
              }))
            })()
          }
