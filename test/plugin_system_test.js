...
describe('plugin_system_test', () => {
  ...
  it('時間加算', () => {
    ...
    cmp('「00:00:01」に「1時間」を時刻加算。それを表示', '01:00:01')
    cmp('「00:00:01」に「2分」を時刻加算。それを表示', '00:02:01')
    cmp('「00:00:01」に「3秒」を時刻加算。それを表示', '00:00:04')
    cmp('「00:00:01」に「1時間」を時刻減算。それを表示', '23:00:01')
    cmp('「00:00:01」に「2分」を時刻減算。それを表示', '23:58:01')
    cmp('「00:00:01」に「3秒」を時刻減算。それを表示', '23:59:58')
  })
  it('文字種変換', () => {
