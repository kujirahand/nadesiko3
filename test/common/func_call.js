...
const NakoSyntaxError = require('nako3/nako_parser_base').NakoSyntaxError
...
describe('関数呼び出しテスト', () => {
  ...
  it('関数の代入的呼び出しその3', () => {
    ...
    assert.throws(
      ...
      NakoSyntaxError, `引数がない関数『${funcName}』を代入的呼び出しすることはできません。`
    )
  })
  it('関数の代入的呼び出しその4', () => {
    const funcName = 'テスト'
    assert.throws(
      ...
      NakoSyntaxError, `引数が2つ以上ある関数『${funcName}』を代入的呼び出しすることはできません。`
    )
  })
  it('関数の代入的呼び出しその5', () => {
    const funcName = 'テスト'
